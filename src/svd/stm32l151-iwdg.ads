...
package STM32L151.IWDG is
   ...
   subtype KR_KEY_Field is STM32L151.UInt16;
   ...
   subtype PR_PR_Field is STM32L151.UInt3;
   ...
   type PR_Register is record
      ...
      PR            : PR_PR_Field := 16#0#;
      --  unspecified
      Reserved_3_31 : STM32L151.UInt29 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype RLR_RL_Field is STM32L151.UInt12;
   ...
   subtype SR_PVU_Field is STM32L151.Bit;
   subtype SR_RVU_Field is STM32L151.Bit;
   ...
   type SR_Register is record
      ...
      RVU           : SR_RVU_Field;
      --  unspecified
      Reserved_2_31 : STM32L151.UInt30;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
